...
export default function CertificateRewards() {
  ...
  const handleDownload = (cert: Certificate) => {
    ...
    doc.setFontSize(11);
    doc.text(
      `Issued on: ${cert.date || new Date().toLocaleDateString()}`,
      148.5,
      165,
      { align: "center" },
    );
    ...
    <>
      <Dialog open={showClaimDialog} onOpenChange={setShowClaimDialog}>
        <DialogContent className="sm:max-w-lg border-2 border-[hsl(221,83%,53%)]/20 overflow-hidden bg-white">
          ...
          <div
            className="absolute bottom-0 right-0 w-40 h-40 bg-[hsl(262,83%,58%)]/10 rounded-full blur-3xl animate-pulse"
            ...
            >
              <div className="relative">
                ...
                <div className="relative p-6 bg-gradient-to-br from-[hsl(221,83%,53%)]/10 via-[hsl(262,83%,58%)]/5 to-[hsl(221,83%,53%)]/10 rounded-lg border-2 border-[hsl(221,83%,53%)]/30 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="font-bold text-[hsl(240,10%,10%)] text-lg">
                      Your Reward:
                    </p>
                  </div>
                  <motion.p
              ...
              >
                <div className="flex items-start gap-3 p-4 bg-[hsl(262,83%,58%)]/5 rounded-lg border border-[hsl(262,83%,58%)]/20">
                  ...
                  <div>
                    <p className="font-semibold text-[hsl(240,10%,10%)] mb-1">
                      Check Your Email
                    </p>
                    <p className="text-sm text-[hsl(240,4%,46%)]">
                      We've sent you a confirmation email with detailed
                ...
                <div className="flex items-start gap-3 p-4 bg-[hsl(221,83%,53%)]/5 rounded-lg border border-[hsl(221,83%,53%)]/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[hsl(240,4%,46%)]">
                      You'll receive your reward details within 24 hours. Keep
                      up the great work!
                    </p>
                  </div>
                </div>
                    ...
                    >
                      ...
                      >
                        ...
                        {cert.earned && (
                          <>
                            <div
                              className="absolute top-0 left-0 w-20 h-20 border-t-4 border-l-4 rounded-tl-lg opacity-30"
                              style={{ borderColor: cert.color }}
                            />
                            <div
                              className="absolute bottom-0 right-0 w-20 h-20 border-b-4 border-r-4 rounded-br-lg opacity-30"
                              style={{ borderColor: cert.color }}
                            />
                          </>
                        )}
                          ...
                          <motion.div
                            ...
                            style={{
                              ...
                              boxShadow: cert.earned
                                ? `0 10px 40px ${cert.color}30`
                                : "none",
                            }}
                            whileHover={
                              cert.earned ? { scale: 1.1, rotate: 5 } : {}
                            }
                          >
                            {cert.earned && (
                              <div
                            ...
                            <div className="p-3 bg-gradient-to-br from-[hsl(221,83%,53%)]/5 to-[hsl(262,83%,58%)]/5 border border-[hsl(221,83%,53%)]/20 rounded-lg">
                              <div className="flex items-start gap-2">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-[hsl(240,4%,46%)]">
                                    {cert.unlockRequirement}
                                  </p>
                                </div>
                              </div>
                            </div>
                ...
                <AnimatePresence>
                  {rewards.map((reward, index) => (
                    <motion.div
                      ...
                      transition={{ delay: index * 0.1 }}
                      whileHover={{
                        y: reward.claimable && !reward.claimed ? -5 : 0,
                      }}
                    >
                      <Card
                        className={`relative overflow-hidden h-full border-2 bg-white ${
                          reward.claimed
                      ...
                      >
                        ...
                        <CardContent className="space-y-4">
                          <div className="p-4 bg-[hsl(262,83%,58%)]/5 border border-dashed border-[hsl(262,83%,58%)]/30 rounded-lg">
                            <p className="text-sm font-bold text-[hsl(262,83%,58%)] mb-1">
                              Your Reward:
                            </p>
                            <p className="text-lg font-semibold text-[hsl(240,10%,10%)]">
                              {reward.rewardItem}
                            </p>
                          </div>
