    ...
    const fetchLeaderboard = async () => {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_API_URL.replace(/\/+$/, "")}/api/leaderboard`,
          {
            credentials: "include",
          },
        );
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover the top eco-warriors in our community and see how your
            impact compares.
          </p>
        </div>
                      ...
                      >
                        ...
                        <CardContent className="p-6 text-center space-y-4">
                          <div className="relative inline-block">
                            ...
                            <div
                              className={`absolute -top-2 -right-2 w-10 h-10 rounded-full flex items-center justify-center shadow-lg ${getRankBadgeColor(index + 1)}`}
                            >
                          ...
                          <div>
                            ...
                            <Badge
                              variant="outline"
                              className={`mt-2 ${getTierColor(actualUser.tier)}`}
                            >
                              {actualUser.tier}
                            </Badge>
                          </div>
                          ...
                          <div className="bg-primary/5 rounded-lg p-3 border border-primary/20">
                            ...
                            <div className="font-bold text-2xl mt-1">
                              {actualUser.totalScore.toLocaleString()}
                            </div>
                          </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Badge
                              variant="outline"
                              className={`text-xs ${getTierColor(user.tier)}`}
                            >
                              {user.tier}
                            </Badge>
                          </div>
              ...
              {pending ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 mb-6">
                    <div className="bg-card/60 border-2 border-yellow-200 shadow-lg shadow-yellow-100/50 rounded-lg py-3">
                      ...
                      <p className="text-xl font-semibold text-foreground">
                        #{userLeaderboard.currentRank}
                      </p>
                    </div>
                    <div className="bg-card/60 border-2 border-yellow-200 shadow-lg shadow-yellow-100/50 rounded-lg py-3">
                      <p className="text-xs uppercase font-medium text-muted-foreground ${getTierColor(actualUser.tier)}">
                        Tier Level
                      </p>
                      <Badge
                        className={`text-l font-semibold text-foreground ${getTierColor(userLeaderboard.tier)}`}
                      >
                        {userLeaderboard.tier}
                      </Badge>
                    </div>
                    <div className="bg-card/60 border-2 border-yellow-200 shadow-lg shadow-yellow-100/50 rounded-lg py-3">
                      <p className="text-xs uppercase font-medium text-muted-foreground">
                ...
                <>
                  <p className="text-muted-foreground mb-4">
                    Your rank will be available after you track your carbon
                    footprint.
                  </p>
                  <Button asChild>
                    <Link
