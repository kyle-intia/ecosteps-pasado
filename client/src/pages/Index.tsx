          ...
          <div className="text-center text-primary-foreground space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl text-primary-foreground/90 max-w-3xl mx-auto pt-8">
                Join thousands of eco-warriors making a positive impact on our
                planet. Monitor, reduce, and offset your carbon emissions with
                EcoSteps.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-10 pb-8">
              ...
              <Button
                variant="outline"
                size="xl"
                className="bg-card/10 border-primary-foreground/30 text-primary-foreground hover:bg-card/20 transition-all duration-300 ease-out"
                asChild
              >
            ...
            {/* <div className="flex items-center justify-center space-x-8 text-primary-foreground/90 pt-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold">PUP</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Comprehensive tools to track, analyze, and reduce your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="shadow-card border-border transition-all duration-300 ease-out hover:shadow-elevated transition-smooth">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Monitor your daily carbon emissions across transportation,
                  energy, and food
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="shadow-card border-border transition-all duration-300 ease-out hover:shadow-elevated transition-smooth">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Connect with like-minded individuals and share eco-friendly
                  tips
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="shadow-card border-border transition-all duration-300 ease-out hover:shadow-elevated transition-smooth">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Earn eco-badges and compete on leaderboards for sustainable
                  living
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <div className="relative">
              ...
              <Card className="relative shadow-elevated border-border">
                <CardHeader>
                  ...
                  <CardDescription>
                    Get detailed insights into your environmental footprint
                  </CardDescription>
                </CardHeader>
      ...
      <section className="py-24 bg-gradient-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-xl text-primary-foreground/90">
            Start your journey towards a more sustainable future today. Every
            small step counts towards a greener planet.
          </p>
          <Button
            variant="outline"
            size="xl"
