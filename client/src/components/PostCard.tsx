            ...
            {!isOwnPost &&
              ...
              (isFollowing ? (
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => onToggleFollow(post.author._id, false)}
                >
                ...
                <Button
                  size="sm"
                  onClick={() => onToggleFollow(post.author._id, true)}
                >
        ...
        <div className="flex items-center justify-between pt-4 border-t border-border">
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className={post.isReposted ? "text-green-600" : ""}
            >
              ...
              {(post.comments || []).map((comment) => (
                <div key={comment._id} className="flex gap-3">
                  <Avatar className="h-8 w-8">
                    ...
                    <AvatarFallback>
                      {comment.authorProfile?.username?.[0] || "?"}
                    </AvatarFallback>
                  </Avatar>
                  <div className="flex-1">
                    <p className="text-sm font-medium">
                      {comment.authorProfile?.firstName &&
                      comment.authorProfile?.lastName
