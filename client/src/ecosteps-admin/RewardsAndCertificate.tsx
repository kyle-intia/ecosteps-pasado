...
const AdminCertificatesRewards = () => {
  ...
  const [isEditingCertificate, setIsEditingCertificate] = useState<any | null>(
    null,
  );
  ...
  const saveCertificate = async () => {
    ...
    if (
      !target.title ||
      !target.unlockRequirement?.type ||
      Number(target.unlockRequirement?.value) <= 0
    ) {
      toast({
        title: "Validation",
        description: "Title and requirement value are required",
        variant: "destructive",
      });
      return;
    }
  ...
  const openEditReward = async (rew: any) => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to fetch reward",
        variant: "destructive",
      });
    }
  };
  ...
  const saveReward = async () => {
    ...
    if (
      !target.title ||
      !target.rewardItem ||
      Number(target.claimRequirement?.value) <= 0
    ) {
      toast({
        title: "Validation",
        description: "Title, reward item and claim value are required",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage certificates users can earn and rewards they can claim
          </p>
        </div>
          ...
          <Card className="shadow-sm border-admin-border">
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Certificates are awarded when users meet unlock requirements
              </p>
            </CardHeader>
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {certificates.map((c) => (
                    <TableRow key={c._id} className="hover:bg-admin-hover">
                      ...
                      <TableCell>
                        {(c.unlockRequirement?.type || "-") +
                          ": " +
                          (c.unlockRequirement?.value ?? "-")}
                      </TableCell>
                      <TableCell>
                        <Badge variant={c.earned ? "secondary" : "outline"}>
              ...
              {certificates.length === 0 && !loading && (
                <div className="p-6 text-center text-sm text-muted-foreground">
                  No certificates yet. Add one using the button below.
                </div>
              )}
          ...
          <Card className="shadow-sm border-admin-border">
            ...
            <CardContent>
                ...
                <TableBody>
                  {rewards.map((r) => (
                    <TableRow key={r._id} className="hover:bg-admin-hover">
                      ...
                      <TableCell>
                        {(r.claimRequirement?.type || "-") +
                          ": " +
                          (r.claimRequirement?.value ?? "-")}
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant={
              ...
              {rewards.length === 0 && !loading && (
                <div className="p-6 text-center text-sm text-muted-foreground">
                  No rewards yet. Add one using the button below.
                </div>
              )}
      ...
      <Dialog
        open={!!isEditingCertificate}
        onOpenChange={(open) => {
          if (!open) setIsEditingCertificate(null);
        }}
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Modify certificate details and unlock requirement
            </DialogDescription>
          </DialogHeader>
          ...
          {isEditingCertificate && (
            <div className="space-y-4">
              <div className="space-y-2">
                <Label>Title</Label>
                <Input
                  value={isEditingCertificate.title}
                  onChange={(e) =>
                    setIsEditingCertificate({
                      ...isEditingCertificate,
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  value={isEditingCertificate.body}
                  onChange={(e) =>
                    setIsEditingCertificate({
                      ...isEditingCertificate,
                      body: e.target.value,
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <Label>Color</Label>
                  <Input
                    value={isEditingCertificate.color}
                    onChange={(e) =>
                      setIsEditingCertificate({
                        ...isEditingCertificate,
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    value={isEditingCertificate.unlockRequirement?.type || ""}
                    onChange={(e) =>
                      setIsEditingCertificate({
                        ...isEditingCertificate,
                        unlockRequirement: {
                          ...(isEditingCertificate.unlockRequirement || {}),
                          type: e.target.value,
                        },
                      })
                    }
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={isEditingCertificate.unlockRequirement?.value || ""}
                    onChange={(e) =>
                      setIsEditingCertificate({
                        ...isEditingCertificate,
                        unlockRequirement: {
              ...
              <div className="flex gap-2">
                <Button className="flex-1" onClick={saveCertificate}>
                  <Save className="h-4 w-4" /> Save
                </Button>
                <Button
                  variant="outline"
                  className="flex-1"
                  onClick={() => setIsEditingCertificate(null)}
                >
                  Cancel
                </Button>
              </div>
      ...
      <Dialog open={isAddingCertificate} onOpenChange={setIsAddingCertificate}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new certificate with unlock requirements
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <IconPicker
                  ...
                  onChange={(value) =>
                    setNewCertificate({ ...newCertificate, icon: value })
                  }
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <Label>Requirement Type *</Label>
                <Input
                  value={newCertificate.unlockRequirement.type}
                  onChange={(e) =>
                    setNewCertificate({
                      ...newCertificate,
                      unlockRequirement: {
                        ...newCertificate.unlockRequirement,
                        type: e.target.value,
                      },
                    })
                  }
              ...
              <div>
                ...
                <Input
                  type="number"
                  value={newCertificate.unlockRequirement.value}
                  onChange={(e) =>
                    setNewCertificate({
                      ...newCertificate,
                      unlockRequirement: {
      ...
      <Dialog
        open={!!isEditingReward}
        onOpenChange={(open) => {
          if (!open) setIsEditingReward(null);
        }}
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Modify reward and claim requirement
            </DialogDescription>
          </DialogHeader>
          ...
          {isEditingReward && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={isEditingReward.rewardItem}
                  onChange={(e) =>
                    setIsEditingReward({
                      ...isEditingReward,
                      rewardItem: e.target.value,
                    })
                  }
                />
              </div>
              ...
              <div>
                ...
                <IconPicker
                  ...
                  onChange={(value) =>
                    setIsEditingReward({ ...isEditingReward, icon: value })
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Select
                    value={isEditingReward.rewardType}
                    onValueChange={(v) =>
                      setIsEditingReward({ ...isEditingReward, rewardType: v })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="flex items-center gap-2">
                  <div className="w-full">
                    ...
                    <Switch
                      checked={!!isEditingReward.claimable}
                      onCheckedChange={(v) =>
                        setIsEditingReward({ ...isEditingReward, claimable: v })
                      }
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    value={isEditingReward.claimRequirement?.type || ""}
                    onChange={(e) =>
                      setIsEditingReward({
                        ...isEditingReward,
                        claimRequirement: {
                          ...(isEditingReward.claimRequirement || {}),
                          type: e.target.value,
                        },
                      })
                    }
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={isEditingReward.claimRequirement?.value || ""}
                    onChange={(e) =>
                      setIsEditingReward({
                        ...isEditingReward,
                        claimRequirement: {
              ...
              <div className="flex gap-2">
                <Button className="flex-1" onClick={saveReward}>
                  <Save className="h-4 w-4" /> Save
                </Button>
                <Button
                  variant="outline"
                  className="flex-1"
                  onClick={() => setIsEditingReward(null)}
                >
                  Cancel
                </Button>
              </div>
      ...
      <Dialog open={isAddingReward} onOpenChange={setIsAddingReward}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new reward that users can claim
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>Reward Item *</Label>
              <Input
                value={newReward.rewardItem}
                onChange={(e) =>
                  setNewReward({ ...newReward, rewardItem: e.target.value })
                }
            ...
            <div>
              ...
              <IconPicker
                ...
                onChange={(value) =>
                  setNewReward({ ...newReward, icon: value })
                }
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setNewReward({ ...newReward, rewardType: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="flex items-center gap-2">
                <div className="w-full">
                  <Label>Claimable</Label>
                  <Switch
                    checked={!!newReward.claimable}
                    onCheckedChange={(v) =>
                      setNewReward({ ...newReward, claimable: v })
                    }
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <Label>Claim Requirement Type *</Label>
                <Input
                  value={newReward.claimRequirement.type}
                  onChange={(e) =>
                    setNewReward({
                      ...newReward,
                      claimRequirement: {
                        ...newReward.claimRequirement,
                        type: e.target.value,
                      },
                    })
                  }
              ...
              <div>
                ...
                <Input
                  type="number"
                  value={newReward.claimRequirement.value}
                  onChange={(e) =>
                    setNewReward({
                      ...newReward,
                      claimRequirement: {
