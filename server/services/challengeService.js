...
// Service for managing daily eco-challenges including selection algorithm and recalculation engine
...
const CHALLENGE_LIBRARY = {
  ...
  telecommute_champion: {
    ...
    description: "Work from home and avoid commute emissions today.",
    category: "transport",
    calculationType: "override",
    savingsValue: "calculated",
    targetQuestion: "Q1",
  ...
  leftover_legend: {
    ...
    description: "Fight food waste! Eat leftovers for one meal today.",
    category: "food",
    calculationType: "override",
    savingsValue: 2.0,
    targetQuestion: "Q7",
  ...
  localvore_lunch: {
    id: "localvore_lunch",
    title: "Localvore Lunch",
    description: "Choose lunch with local ingredients to reduce food miles.",
    category: "food",
    calculationType: "fixed_credit",
    savingsValue: 0.5
  }
...
class ChallengeService {
   ...
   * @returns {Object} Challenge document with today's challenges
   */
  ...
  /**
   * Complete a specific challenge and trigger recalculation
   * @param {string} userId - User ID
