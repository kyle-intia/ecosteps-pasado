...
exports.resetPasswordHandler =
  exports.sendPasswordResetHandler =
  exports.verifyEmailHandler =
...
exports.registerHandler = (0, catchErrors_1.default)(async (req, res) => {
  ...
  auth_service_1.createAccount)(request);
...
exports.loginHandler = (0, catchErrors_1.default)(async (req, res) => {
  ...
  const { accessToken, refreshToken, user } = await (0,
  auth_service_1.loginUser)(request);
  return (0, cookies_1.setAuthCookies)({ res, accessToken, refreshToken })
    .status(http_1.OK)
    .json({
...
exports.refreshHandler = (0, catchErrors_1.default)(async (req, res) => {
  ...
  const { accessToken, newRefreshToken } = await (0,
  auth_service_1.refreshUserAccessToken)(refreshToken);
  if (newRefreshToken) {
    res.cookie(
      "refreshToken",
      newRefreshToken,
      (0, cookies_1.getRefreshTokenCookieOptions)(),
    );
  }
  res.cookie(
    "accessToken",
    accessToken,
    (0, cookies_1.getAccessTokenCookieOptions)(),
  );
  return res.status(http_1.OK).json({ message: "Access token refreshed" });
});

exports.verifyEmailHandler = (0, catchErrors_1.default)(async (req, res) => {
  const verificationCode = auth_schemas_1.verificationCodeSchema.parse(
    req.params.code,
  );
...
exports.sendPasswordResetHandler = (0, catchErrors_1.default)(
  async (req, res) => {
